...
We started developing algorithmic trading systems on MetaTrader 4 (MT4) in October 2015 and we moved onto developing a more advanced system on Dukascopy JForex in May 2016. Our trading system development has come on in leaps and bounds ever since: evolved to its second (2nd) generation in February 2019 and third (3rd) generation in November 2019. We have been trading *LIVE* since the beginning, so our trading performance can be audited by prospective clients on our Dukascopy JForex account with  *LIVE* trading results dated back as early as in May 2016.

All Cyamus trading systems are developed based on a single cohesive proprietary strategy, which encompasses proven trading ideologies, such as **diversification through uncorrelated instruments** and money management. We adhere to a development principle that new development ideas are only accepted if they can perform well on multiple markets. We believe that it is the litmus test of a system's robustness to **keep up with the ever-changing market regimes**.
