...
All Cyamus trading systems are developed based on a single cohesive proprietary strategy, which encompasses undisputed trading ideologies, such as **diversification through low-correlated instruments**. Furthermore, market regimes are ever-changing. To avoid entrapment in local optimum, as a litmus test of robustness, new development ideas are only accepted if they can perform well on multiple markets.
